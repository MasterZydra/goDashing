...
func (j *radarchart) Work(send chan *dashing.Event, webroot string, url string, token string) {
	...
	for {
		...
		case <-ticker.C:
			...
			send <- dashing.NewEvent("radarchart", map[string]interface{}{
